...
**workflow for the quantification, differential expression analysis and miRNA target prediction of circRNAs in RNA-Seq datasets**.
...
nf-core/circrna was originally written by BarryDigby.
